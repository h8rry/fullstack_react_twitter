    ...
    <React.Fragment>
      <nav className="navbar navbar-expand navbar-light bg-light">
        ...
        <div className="collapse navbar-collapse w-100 order-3 dual-collapse2">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item">
            <button className="btn btn-danger float-right buttons" id="log-out" onClick={this.handleClick}>Log Out</button>
            <button className="btn btn-secondary float-right buttons" onClick={this.handleClick2}>See only my feeds</button>
            <button className="btn btn-secondary float-right buttons" onClick={this.handleClick3}>See all feeds</button>
            </li>
          </ul>
        </div>
      </nav>
